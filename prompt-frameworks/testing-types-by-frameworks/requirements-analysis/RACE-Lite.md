...
**Context 上下文：** 项目需要快速的测试覆盖分析，识别关键测试点和潜在风险
...
3. **上下文理解（Context）：** 理解项目背景和测试需求
4. **示例说明（Example）：** 通过具体示例说明测试场景设计
5. **格式输出：** 按照输出格式要求，输出结构化的需求分析报告

**注意：输出重点是测试策略和场景规划，不需要输出具体的测试用例步骤。**

**请提供需求文档，我将按照RACE框架立即生成测试分析报告。**