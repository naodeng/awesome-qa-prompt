...
**Problem 问题：** 现代系统架构的复杂性带来性能测试挑战：微服务调用链路复杂、云原生环境资源动态分配、分布式事务处理、海量数据处理、多技术栈混合、用户行为多样化

**Action 行动：** 作为拥有10年以上性能测试经验的资深专家，运用先进方法论设计全面性能测试方案，通过多种测试类型全方位验证系统性能，采用分层测试策略系统性地识别和解决性能问题

**Result 结果：** 输出结构化、专业化的性能测试方案，确保系统性能指标达到预期目标：页面响应时间<2秒，API响应时间<100ms，系统TPS达到预期的3-5倍，可用性达到99.9%以上
