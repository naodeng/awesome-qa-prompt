...
- **文件位置**：`testing-types/functional-testing/Standard-version/FunctionalTestingPrompt.md`
- **功能描述**：设计功能测试策略和执行方案
- **适用场景**：功能测试执行、回归测试
- **核心能力**：
  - 黑盒测试方法和功能分解测试
...
- **文件位置**：`testing-types/performance-testing/Standard-version/PerformanceTestingPrompt.md`
...
- **文件位置**：`testing-types/automation-testing/Standard-version/AutomationTestingPrompt.md`
- **功能描述**：自动化测试脚本设计和框架选择
...
- **文件位置**：`testing-types/mobile-testing/Standard-version/MobileTestingPrompt.md`
- **功能描述**：移动应用测试策略和场景设计
- **适用场景**：移动应用测试、兼容性测试
- **核心能力**：
...
- **文件位置**：`testing-types/bug-reporting/Standard-version/BugReportingPrompt.md`
- **功能描述**：标准化缺陷报告模板和缺陷分析
- **适用场景**：缺陷管理、缺陷分析
- **核心能力**：
  - 缺陷识别原则和分类体系
...
- **文件位置**：`testing-types/test-reporting/Standard-version/TestReportingPrompt.md`
- **功能描述**：测试执行报告和质量分析报告
- **适用场景**：测试总结、质量评估
- **核心能力**：
  - 多类型测试报告编写
...
- **文件位置**：`testing-types/test-strategy/Standard-version/TestStrategyPrompt.md`
...
- **文件位置**：`testing-types/ai-assisted-testing/Standard-version/AIAssistedTestingPrompt.md`
...
- **文件位置**：`testing-types/manual-testing/Standard-version/ManualTestingPrompt.md`
- **功能描述**：手动测试策略和探索性测试
- **适用场景**：探索性测试、用户体验测试
- **核心能力**：
  - 探索性测试方法和技巧
...
- **文件位置**：`testing-types/security-testing/Standard-version/SecurityTestingPrompt.md`
- **功能描述**：安全漏洞检测和安全测试策略
- **适用场景**：安全审计、渗透测试
- **核心能力**：
  - OWASP Top 10 漏洞测试
...
- **文件位置**：`testing-types/api-testing/Standard-version/APITestingPrompt.md`
- **功能描述**：API接口测试和集成测试
- **适用场景**：接口测试、微服务测试
- **核心能力**：
  - RESTful API测试设计
...
- **文件位置**：`testing-types/accessibility-testing/Standard-version/AccessibilityTestingPrompt.md`
...
- **文件位置**：`testing-types/test-case-reviewer/Standard-version/TestCaseReviewerPrompt.md`
- **功能描述**：专业的测试用例审核和质量把控
