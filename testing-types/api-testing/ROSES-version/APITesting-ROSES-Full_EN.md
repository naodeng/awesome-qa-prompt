...
**Objective:** Based on the provided API documentation, system architecture, or testing requirements, design comprehensive API testing strategies and testing plans, ensuring API testing coverage is complete, methods are scientific, automation level is high, and can effectively guarantee API functional correctness, performance, and security

**Scenario:** Need to design testing plans for APIs or API-driven systems, involving API functional verification, performance testing, security testing, contract testing, integration testing, etc., requiring comprehensive consideration of multiple factors including API protocol types, system architecture, business requirements, and quality requirements

**Expected Solution:** Output detailed API testing plan documentation, including testing overview, API documentation analysis, API testing strategy, detailed testing plans, specialized testing plans, API test automation, API testing reports, and other complete content, providing executable API test cases and automation scripts
