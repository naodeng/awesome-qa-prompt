...
**Objective 目标：** 基于发现的问题，快速生成标准化的缺陷报告，包含问题描述、重现步骤、影响评估等核心信息

**Scenario 场景：** 在测试过程中发现了问题，需要快速编写缺陷报告，帮助开发团队快速定位和解决问题

**Expected Solution 预期解决方案：** 输出简洁的缺陷报告，重点突出问题描述、重现步骤、预期与实际结果对比、环境信息等核心内容

**Steps 步骤：** 问题识别 → 信息收集 → 重现验证 → 报告编写 → 格式化输出
