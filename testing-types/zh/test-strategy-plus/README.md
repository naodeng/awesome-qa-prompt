# 测试策略增强版 (Test Strategy Plus)

[English](../../en/test-strategy-plus/README.md) | 简体中文
...
- 已明确要围绕 测试策略增强版 产出测试方案、测试资产结构或评审意见
...
- **标准版本：** [Standard-version/TestStrategyPlusPrompt.md](Standard-version/TestStrategyPlusPrompt.md)
- **英文版本：** [../../en/test-strategy-plus/Standard-version/TestStrategyPlusPrompt.md](../../en/test-strategy-plus/Standard-version/TestStrategyPlusPrompt.md)
