...
|----------|----------|--------|--------|----------|
| 测试执行 | 用例执行率 | [目标值] | [实际值] | [达成/未达成] |
| 测试质量 | 用例通过率 | [目标值] | [实际值] | [达成/未达成] |
| 缺陷质量 | P0缺陷数量 | [目标值] | [实际值] | [达成/未达成] |
| 覆盖率 | 需求覆盖率 | [目标值] | [实际值] | [达成/未达成] |
...
|----------|----------|----------|----------|----------|--------|--------|
| [模块A] | [计划数] | [执行数] | [通过数] | [失败数] | [通过率] | [执行率] |
| [模块B] | [计划数] | [执行数] | [通过数] | [失败数] | [通过率] | [执行率] |
| [模块C] | [计划数] | [执行数] | [通过数] | [失败数] | [通过率] | [执行率] |
| [模块D] | [计划数] | [执行数] | [通过数] | [失败数] | [通过率] | [执行率] |
| **总计** | **[计划总数]** | **[执行总数]** | **[通过总数]** | **[失败总数]** | **[总体通过率]** | **[总体执行率]** |

#### 分测试类型执行情况
| 测试类型 | 计划用例 | 执行用例 | 通过用例 | 失败用例 | 通过率 |
|----------|----------|----------|----------|----------|--------|
| 功能测试 | [计划数] | [执行数] | [通过数] | [失败数] | [通过率] |
| 接口测试 | [计划数] | [执行数] | [通过数] | [失败数] | [通过率] |
| 性能测试 | [计划数] | [执行数] | [通过数] | [失败数] | [通过率] |
| 安全测试 | [计划数] | [执行数] | [通过数] | [失败数] | [通过率] |
