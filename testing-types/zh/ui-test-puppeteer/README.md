# UI 自动化测试（Puppeteer） (UI Test Puppeteer)

[English](../../en/ui-test-puppeteer/README.md) | 简体中文
...
- 已明确要围绕 UI 自动化测试（Puppeteer） 产出测试方案、测试资产结构或评审意见
...
- **标准版本：** [Standard-version/UITestPuppeteerPrompt.md](Standard-version/UITestPuppeteerPrompt.md)
- **英文版本：** [../../en/ui-test-puppeteer/Standard-version/UITestPuppeteerPrompt.md](../../en/ui-test-puppeteer/Standard-version/UITestPuppeteerPrompt.md)
