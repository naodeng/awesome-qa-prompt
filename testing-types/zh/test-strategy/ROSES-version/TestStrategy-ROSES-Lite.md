# 测试策略 - ROSES框架 (轻量版) - Default版

<!-- Prompt purpose: 用于测试策略 - ROSES框架 (的风险识别、证据梳理与可执行测试建议输出。 -->
## 平台场景说明
...
**Objective 目标：** 基于项目特点，快速制定全面的测试策略和实施计划，确保测试策略目标明确、方法科学、资源合理

**Scenario 场景：** 需要为项目制定测试策略，涉及测试目标、测试范围、测试方法、资源配置等核心要素

**Expected Solution 预期解决方案：** 输出简洁的测试策略文档，重点突出测试概况、测试目标、测试范围、测试策略、测试计划、资源规划、风险管理等核心内容

**Steps 步骤：** 项目分析 → 目标制定 → 策略设计 → 资源规划 → 风险识别
