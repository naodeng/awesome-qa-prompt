# 测试策略 Prompt (精简版) - Default版

<!-- Prompt purpose: 用于测试策略 Prompt (精简版的风险识别、证据梳理与可执行测试建议输出。 -->
## 平台场景说明
...
#### 质量目标
- **功能质量：** 功能完整性：[待确认]
- **性能质量：** 响应时间：[待确认]；并发：[待确认]（未提供时不要填经验值）
- **安全质量：** 无高危安全漏洞
- **用户体验：** 用户满意度：[待确认]
...
| 集成测试 | 模块间交互 | [待确认] | [待确认] | 每日构建 |
| 系统测试 | 端到端功能 | [待确认] | [待确认] | 每个版本 |
| 验收测试 | 业务场景验证 | [待确认] | [待确认] | 发布前 |

#### 测试类型策略
- **功能测试（占比待确认）：** 核心业务功能验证
- **性能测试（占比待确认）：** 响应时间和并发能力
- **安全测试（占比待确认）：** 安全漏洞和数据保护
- **兼容性测试 (15%)：** 跨平台和浏览器兼容
- **可用性测试 (10%)：** 用户体验和易用性
