...
[English](../../en/code-review/README.md) | 简体中文
...
- 已明确要围绕 代码审查 产出测试方案、测试资产结构或评审意见
...
- **标准版本：** [Standard-version/CodeReviewPrompt.md](Standard-version/CodeReviewPrompt.md)
- **英文版本：** [../../en/code-review/Standard-version/CodeReviewPrompt.md](../../en/code-review/Standard-version/CodeReviewPrompt.md)
