# UI 自动化测试（TestCafe） (UI Test TestCafe)

[English](../../en/ui-test-testcafe/README.md) | 简体中文
...
- 已明确要围绕 UI 自动化测试（TestCafe） 产出测试方案、测试资产结构或评审意见
...
- **标准版本：** [Standard-version/UITestTestCafePrompt.md](Standard-version/UITestTestCafePrompt.md)
- **英文版本：** [../../en/ui-test-testcafe/Standard-version/UITestTestCafePrompt.md](../../en/ui-test-testcafe/Standard-version/UITestTestCafePrompt.md)
