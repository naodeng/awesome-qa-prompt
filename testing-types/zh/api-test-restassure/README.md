# API 测试（Rest Assured） (API Test Rest Assured)

[English](../../en/api-test-restassure/README.md) | 简体中文
...
- 已明确要围绕 API 测试（Rest Assured） 产出测试方案、测试资产结构或评审意见
...
- **标准版本：** [Standard-version/APITestRestAssuredPrompt.md](Standard-version/APITestRestAssuredPrompt.md)
- **英文版本：** [../../en/api-test-restassure/Standard-version/APITestRestAssuredPrompt.md](../../en/api-test-restassure/Standard-version/APITestRestAssuredPrompt.md)
