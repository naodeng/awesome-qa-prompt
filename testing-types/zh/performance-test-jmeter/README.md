# 性能测试（JMeter） (Performance Test JMeter)

[English](../../en/performance-test-jmeter/README.md) | 简体中文

## 模块简介

面向 JMeter 的性能测试提示词，覆盖线程组、采样器、参数化、断言、监听器和分布式执行。

## 适用场景

- 已明确要围绕 性能测试（JMeter） 产出测试方案、测试资产结构或评审意见
...
- **标准版本：** [Standard-version/PerformanceTestJMeterPrompt.md](Standard-version/PerformanceTestJMeterPrompt.md)
- **英文版本：** [../../en/performance-test-jmeter/Standard-version/PerformanceTestJMeterPrompt.md](../../en/performance-test-jmeter/Standard-version/PerformanceTestJMeterPrompt.md)
