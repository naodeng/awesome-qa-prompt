...
[English](../../en/api-testing/README.md) | 简体中文
...
- **文件：** `../../en/api-testing/Standard-version/APITestingPrompt.md`
...
1. **选择提示词文件**
   ...
   - 英文项目使用 `../../en/api-testing/Standard-version/APITestingPrompt.md`
