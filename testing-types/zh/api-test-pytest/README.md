# API 测试（Pytest） (API Test Pytest)

[English](../../en/api-test-pytest/README.md) | 简体中文
...
- 已明确要围绕 API 测试（Pytest） 产出测试方案、测试资产结构或评审意见
...
- **标准版本：** [Standard-version/APITestPytestPrompt.md](Standard-version/APITestPytestPrompt.md)
- **英文版本：** [../../en/api-test-pytest/Standard-version/APITestPytestPrompt.md](../../en/api-test-pytest/Standard-version/APITestPytestPrompt.md)
