# UI 自动化测试（WebdriverIO） (UI Test WebdriverIO)

[English](../../en/ui-test-webdriverio/README.md) | 简体中文
...
- 已明确要围绕 UI 自动化测试（WebdriverIO） 产出测试方案、测试资产结构或评审意见
...
- **标准版本：** [Standard-version/UITestWebdriverIOPrompt.md](Standard-version/UITestWebdriverIOPrompt.md)
- **英文版本：** [../../en/ui-test-webdriverio/Standard-version/UITestWebdriverIOPrompt.md](../../en/ui-test-webdriverio/Standard-version/UITestWebdriverIOPrompt.md)
