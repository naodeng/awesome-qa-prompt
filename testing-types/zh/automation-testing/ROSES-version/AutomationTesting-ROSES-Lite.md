...
**Objective 目标：** 基于测试需求，快速生成自动化测试方案，包含技术选型、测试策略、框架设计和 CI/CD 集成

**Scenario 场景：** 项目需要快速建立自动化测试能力，提升测试效率，降低成本，确保软件质量

**Expected Solution 预期解决方案：** 输出简洁的自动化测试方案，重点突出技术选型、测试金字塔策略、核心框架设计和关键实施步骤

**Steps 步骤：** 需求分析 → 技术选型 → 测试策略 → 框架设计 → CI/CD 集成 → 实施计划
