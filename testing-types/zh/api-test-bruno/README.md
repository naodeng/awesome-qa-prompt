# API 测试（Bruno） (API Test Bruno)

[English](../../en/api-test-bruno/README.md) | 简体中文
...
- 已明确要围绕 API 测试（Bruno） 产出测试方案、测试资产结构或评审意见
...
- **标准版本：** [Standard-version/APITestBrunoPrompt.md](Standard-version/APITestBrunoPrompt.md)
- **英文版本：** [../../en/api-test-bruno/Standard-version/APITestBrunoPrompt.md](../../en/api-test-bruno/Standard-version/APITestBrunoPrompt.md)
