# UI 自动化测试（Cypress） (UI Test Cypress)

[English](../../en/ui-test-cypress/README.md) | 简体中文
...
- 已明确要围绕 UI 自动化测试（Cypress） 产出测试方案、测试资产结构或评审意见
...
- **标准版本：** [Standard-version/UITestCypressPrompt.md](Standard-version/UITestCypressPrompt.md)
- **英文版本：** [../../en/ui-test-cypress/Standard-version/UITestCypressPrompt.md](../../en/ui-test-cypress/Standard-version/UITestCypressPrompt.md)
