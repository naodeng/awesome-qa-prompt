# 性能测试（k6） (Performance Test k6)

[English](../../en/performance-test-k6/README.md) | 简体中文
...
- 已明确要围绕 性能测试（k6） 产出测试方案、测试资产结构或评审意见
...
- **标准版本：** [Standard-version/PerformanceTestK6Prompt.md](Standard-version/PerformanceTestK6Prompt.md)
- **英文版本：** [../../en/performance-test-k6/Standard-version/PerformanceTestK6Prompt.md](../../en/performance-test-k6/Standard-version/PerformanceTestK6Prompt.md)
