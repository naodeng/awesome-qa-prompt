...
<!-- Prompt purpose: 用于性能测试 - RISE框架 (完的风险识别、证据梳理与可执行测试建议输出。 -->
---
...
**Input 输入：** 基于提供的系统架构、业务需求或性能目标（包含系统架构文档、业务需求文档、性能目标要求、历史性能数据、测试环境配置信息、监控工具配置等信息），进行全面的信息理解和分析，为性能测试策略制定提供准确的输入基础

**Steps 步骤：** 按照系统化的步骤进行性能测试策略制定：1）需求分析 2）性能目标制定 3）测试策略设计 4）测试场景设计 5）脚本开发 6）测试执行和监控 7）结果分析和优化 8）持续改进

**Expectation 期望：** 输出详细的性能测试方案文档，包含测试概述、系统架构分析、性能需求分析、性能测试场景设计、性能测试执行计划、性能瓶颈分析框架、性能测试报告等完整内容，为项目决策提供可执行的性能测试策略和实施建议
