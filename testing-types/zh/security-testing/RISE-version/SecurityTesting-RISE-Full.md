...
<!-- Prompt purpose: 用于安全测试 - RISE框架 (完的风险识别、证据梳理与可执行测试建议输出。 -->
---
...
**Input 输入：** 基于提供的系统架构、安全需求或合规要求（包含系统架构文档、安全需求文档、合规要求文档、业务场景说明、技术栈信息、历史安全测试数据、测试环境配置信息等信息），进行全面的信息理解和分析，为安全测试策略制定提供准确的输入基础

**Steps 步骤：** 按照系统化的步骤进行安全测试策略制定：1）威胁建模 2）策略制定 3）工具准备 4）测试执行 5）结果分析 6）报告编写 7）持续改进

**Expectation 期望：** 输出详细的安全测试方案文档，包含测试概述、威胁建模分析、安全测试策略、详细测试方案、专项安全测试、安全测试工具链、合规性测试、安全测试报告等完整内容，为项目决策提供可执行的安全测试策略和实施建议
