...
**Scenario:** After test execution is completed, test reports need to be quickly written to provide data support and quality assessment for project decisions

**Expected Solution:** Output concise test report, focusing on test overview, defect statistics, quality assessment, release recommendations, and other core content

**Steps:** Data Collection → Data Analysis → Report Writing → Format Output
