# AI-Assisted Testing - RISE Framework (Lightweight Version)

<!-- Prompt purpose: Supports AI-Assisted Testing - RISE Framework (Lightweight Version) by organizing input evidence, constraints, risks, validation priorities, decision criteria, and actionable QA next steps without inventing facts. -->
---
...
**Input:** Based on the provided testing challenges and AI application scenarios (including project requirement documents, testing challenge descriptions, AI application scenario descriptions, historical test data, technology stack information, and other basic information), conduct information understanding and analysis to provide input foundation for AI-assisted testing strategy formulation

**Steps:** Follow systematic steps for AI-assisted testing strategy formulation: 1) Requirement Analysis 2) Technology Selection 3) Solution Design 4) Effect Evaluation

**Expectation:** Output concise AI-assisted testing solution documentation, highlighting core content such as solution overview, AI application scenarios, implementation plan, and effect evaluation
