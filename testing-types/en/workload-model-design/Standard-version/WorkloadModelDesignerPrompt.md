...
- Build transaction distributions and temporal models from business evidence; distinguish open and closed models; cover seasonality, spikes, and data scale.
...
- Specialized focus: for "workload model design", identify its own core targets, distinctive failure modes, decision rules, and evidence; do not substitute generic checks from the broader domain.
...
3. Result table: population or source, transaction, proportion, arrival or concurrency model, time distribution, evidence, open item

| population or source | transaction | proportion | arrival or concurrency model | time distribution | evidence | open item |
| --- | --- | --- | --- | --- | --- | --- |
