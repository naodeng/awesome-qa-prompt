...
- Identify failure modes from business objectives and system changes; explain ranking using impact, likelihood, and detectability separately; distinguish inherent risk from residual risk after controls.
...
- Specialized focus: for "quality risk analysis", identify its own core targets, distinctive failure modes, decision rules, and evidence; do not substitute generic checks from the broader domain.
...
3. Result table: risk scenario, trigger, impact, likelihood basis, detectability, existing control, residual risk, mitigation and validation

| risk scenario | trigger | impact | likelihood basis | detectability | existing control | residual risk | mitigation and validation |
| --- | --- | --- | --- | --- | --- | --- | --- |
