...
- Audit sample scope and label bias; estimate relative risk using interpretable features only; distinguish correlation from causation; provide risk bands instead of invented probabilities.
...
- Specialized focus: for "defect prediction analysis", identify its own core targets, distinctive failure modes, decision rules, and evidence; do not substitute generic checks from the broader domain.
...
3. Result table: object, feature and source, historical signal, protection evidence, risk band, confidence limitation, recommended check

| object | feature and source | historical signal | protection evidence | risk band | confidence limitation | recommended check |
| --- | --- | --- | --- | --- | --- | --- |
