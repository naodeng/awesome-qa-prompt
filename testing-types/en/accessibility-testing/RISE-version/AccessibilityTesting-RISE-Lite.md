...
<!-- Prompt purpose: Supports Accessibility Testing - RISE Framework (Lightweight Version) by organizing input evidence, constraints, risks, validation priorities, decision criteria, and actionable QA next steps without inventing facts. -->
---
