...
- Compare state before and after execution; trace pollution sources and propagation paths; distinguish isolated incidents, concurrency conflicts, and long-term environment drift.
...
- Specialized focus: for "test data pollution analysis", identify its own core targets, distinctive failure modes, decision rules, and evidence; do not substitute generic checks from the broader domain.
...
3. Result table: pollution symptom, affected object, source hypothesis, propagation path, evidence, isolation or cleanup measure, validation

| pollution symptom | affected object | source hypothesis | propagation path | evidence | isolation or cleanup measure | validation |
| --- | --- | --- | --- | --- | --- | --- |
