...
- Normalize requirement statements while retaining sources; compare outcomes, constraints, and precedence under the same condition; identify direct conflicts, scope overlaps, terminology mismatches, and implicit contradictions.
...
- Specialized focus: for "requirement conflict analysis", identify its own core targets, distinctive failure modes, decision rules, and evidence; do not substitute generic checks from the broader domain.
...
3. Result table: requirement A and source, requirement B and source, conflict type, triggering condition, impact, decision question, possible resolution direction

| requirement A and source | requirement B and source | conflict type | triggering condition | impact | decision question | possible resolution direction |
| --- | --- | --- | --- | --- | --- | --- |
