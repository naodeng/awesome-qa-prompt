# API Testing - ROSES Framework (Lightweight Version)

<!-- Prompt purpose: Supports API Testing - ROSES Framework (Lightweight Version) by organizing input evidence, constraints, risks, validation priorities, decision criteria, and actionable QA next steps without inventing facts. -->
---
...
**Objective:** Based on API documentation, quickly design API testing strategies and automation solutions, ensuring API testing coverage is complete, methods are scientific, and automation level is high

**Scenario:** Need to quickly design testing plans for APIs or API-driven systems, involving core elements such as API functional verification, performance testing, and security testing

**Expected Solution:** Output concise API testing plan documentation, highlighting core content such as testing overview, API testing strategy, functional test design, performance testing, security testing, and automation framework

**Steps:** API Analysis → Strategy Formulation → Test Case Design → Script Development → Automation Integration
