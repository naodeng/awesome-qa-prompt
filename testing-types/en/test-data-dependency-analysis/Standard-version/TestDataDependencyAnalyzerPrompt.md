...
- Build a data dependency graph; identify prerequisites, cycles, and implicit sharing; define creation, reuse, isolation, and teardown order.
...
- Specialized focus: for "test data dependency analysis", identify its own core targets, distinctive failure modes, decision rules, and evidence; do not substitute generic checks from the broader domain.
...
3. Result table: data entity, dependency, dependency type, creation condition, isolation strategy, teardown order, risk

| data entity | dependency | dependency type | creation condition | isolation strategy | teardown order | risk |
| --- | --- | --- | --- | --- | --- | --- |
