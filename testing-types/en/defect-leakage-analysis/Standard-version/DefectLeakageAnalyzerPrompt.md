...
- Confirm the leakage definition and stages per defect; reconstruct why existing controls missed it; distinguish requirement, design, implementation, test, environment, and monitoring gaps; avoid replacing systemic analysis with personal blame.
...
- Specialized focus: for "defect leakage analysis", identify its own core targets, distinctive failure modes, decision rules, and evidence; do not substitute generic checks from the broader domain.
...
3. Result table: defect, leakage stage, expected detection point, control gap, evidence, impact, improvement and validation
