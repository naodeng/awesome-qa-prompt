...
- Trace direct and indirect impact from each change through calls, data, and configuration dependencies; compare contracts before and after; rank by scope, failure consequence, and evidence strength.
...
- Specialized focus: for "change impact analysis", identify its own core targets, distinctive failure modes, decision rules, and evidence; do not substitute generic checks from the broader domain.
...
3. Result table: change item, evidence, direct impact, indirect impact, affected scenario, risk level and basis, validation recommendation

| change item | evidence | direct impact | indirect impact | affected scenario | risk level and basis | validation recommendation |
| --- | --- | --- | --- | --- | --- | --- |
