# Test Case Writing - RISE Framework (Lite Version) - Default Version

<!-- Prompt purpose: Supports Test Case Writing - RISE Framework (Lite Version) - Default Version by organizing input evidence, constraints, risks, validation priorities, decision criteria, and actionable QA next steps without inventing facts. -->
