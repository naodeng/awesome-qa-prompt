# Manual Testing - RISE Framework (Lite Version) - Web Version

<!-- Prompt purpose: Supports Manual Testing - RISE Framework (Lite Version) - Web Version by organizing input evidence, constraints, risks, validation priorities, decision criteria, and actionable QA next steps without inventing facts. -->
