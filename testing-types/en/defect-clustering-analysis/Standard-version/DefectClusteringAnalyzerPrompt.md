...
- Normalize fields and handle missing data first; cluster using interpretable features; report within-cluster evidence, between-cluster differences, and outliers; never treat clustering as proof of a shared root cause.
...
- Specialized focus: for "defect clustering analysis", identify its own core targets, distinctive failure modes, decision rules, and evidence; do not substitute generic checks from the broader domain.
...
3. Result table: defect cluster, shared feature, representative defect, difference or outlier, possible relationship, validation recommendation, data limitation

| defect cluster | shared feature | representative defect | difference or outlier | possible relationship | validation recommendation | data limitation |
| --- | --- | --- | --- | --- | --- | --- |
