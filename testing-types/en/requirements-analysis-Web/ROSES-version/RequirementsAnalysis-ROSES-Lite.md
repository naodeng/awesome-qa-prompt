# Requirements Analysis - ROSES Framework (Lite Version) - Web Version

<!-- Prompt purpose: Supports Requirements Analysis - ROSES Framework (Lite Version) - Web Version by organizing input evidence, constraints, risks, validation priorities, decision criteria, and actionable QA next steps without inventing facts. -->
