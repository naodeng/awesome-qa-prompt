...
<!-- Prompt purpose: Supports Security Testing - ROSES Framework (Full Version) by organizing input evidence, constraints, risks, validation priorities, decision criteria, and actionable QA next steps without inventing facts. -->
---
...
**Objective:** Based on the provided system architecture, security requirements, or compliance requirements, design comprehensive security testing strategies and testing plans, ensuring security testing coverage is complete, methods are scientific, risk assessment is accurate, and can effectively identify and validate system security risks

**Scenario:** Need to design security testing plans for software systems or applications, involving vulnerability scanning, penetration testing, code review, configuration audit, compliance testing, etc., requiring comprehensive consideration of multiple factors including system architecture, security threats, compliance requirements, and business risks

**Expected Solution:** Output detailed security testing plan documentation, including testing overview, threat modeling analysis, security testing strategy, detailed testing plans, specialized security testing, security testing toolchain, compliance testing, security testing reports, and other complete content, providing executable security test cases and test scripts
