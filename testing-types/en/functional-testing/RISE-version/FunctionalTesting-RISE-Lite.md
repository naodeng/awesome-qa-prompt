# Functional Testing - RISE Framework (Lightweight Version) - Default Version

<!-- Prompt purpose: Supports Functional Testing - RISE Framework (Lightweight Version) - Default Version by organizing input evidence, constraints, risks, validation priorities, decision criteria, and actionable QA next steps without inventing facts. -->
