...
- Map each gate condition to the risk it controls; verify evidence freshness and scope match; distinguish blocking, warning, and manual review; define exception approval and expiry.
...
- Specialized focus: for "quality gate analysis", identify its own core targets, distinctive failure modes, decision rules, and evidence; do not substitute generic checks from the broader domain.
...
3. Result table: gate item, risk basis, evidence and source, decision criterion, result status, exception condition, follow-up action

| gate item | risk basis | evidence and source | decision criterion | result status | exception condition | follow-up action |
| --- | --- | --- | --- | --- | --- | --- |
