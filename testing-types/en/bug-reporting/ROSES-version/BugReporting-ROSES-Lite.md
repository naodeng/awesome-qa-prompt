# Bug Reporting - ROSES Framework (Lite Version)

<!-- Prompt purpose: Supports Bug Reporting - ROSES Framework (Lite Version) by organizing input evidence, constraints, risks, validation priorities, decision criteria, and actionable QA next steps without inventing facts. -->
---
...
**Objective:** Based on discovered problems, quickly generate standardized bug reports containing problem descriptions, reproduction steps, impact assessments, and other core information

**Scenario:** Problems are discovered during testing, requiring quick bug report writing to help development teams quickly locate and resolve issues

**Expected Solution:** Output concise bug reports, focusing on problem descriptions, reproduction steps, expected vs actual results comparison, environment information, and other core content

**Steps:** Problem Identification → Information Collection → Reproduction Verification → Report Writing → Format Output
