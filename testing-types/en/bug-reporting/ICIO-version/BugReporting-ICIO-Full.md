...
<!-- Prompt purpose: Supports Bug Reporting - ICIO Framework (Full Version) by organizing input evidence, constraints, risks, validation priorities, decision criteria, and actionable QA next steps without inventing facts. -->
---

## ICIO Framework Structure

**Instruction:** As a senior bug management expert, write detailed and accurate bug reports based on the provided problem phenomena, test environment, or error information
...
**Input Data:** Problem phenomenon descriptions, test environment information, error logs, error screenshots, test data, reproduction steps, business impact assessments, and other relevant information
