# Requirements Analysis - CRISPE Framework (Lite Version) - Mobile Version

<!-- Prompt purpose: Supports Requirements Analysis - CRISPE Framework (Lite Version) - Mobile Version by organizing input evidence, constraints, risks, validation priorities, decision criteria, and actionable QA next steps without inventing facts. -->
