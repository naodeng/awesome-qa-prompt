# Test Strategy Prompt (Lite Version) - Web Version

<!-- Prompt purpose: Supports Test Strategy Prompt (Lite Version) - Web Version by organizing input evidence, constraints, risks, validation priorities, decision criteria, and actionable QA next steps without inventing facts. -->
