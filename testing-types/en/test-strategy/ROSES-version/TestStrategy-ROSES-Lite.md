# Test Strategy - ROSES Framework (Lightweight Version) - Default Version

<!-- Prompt purpose: Supports Test Strategy - ROSES Framework (Lightweight Version) - Default Version by organizing input evidence, constraints, risks, validation priorities, decision criteria, and actionable QA next steps without inventing facts. -->
...
**Objective:** Based on project characteristics, quickly develop comprehensive test strategies and implementation plans, ensuring test strategies have clear objectives, scientific methods, and reasonable resources

**Scenario:** Need to develop test strategies for projects, involving core elements such as test objectives, test scope, test methods, and resource allocation

**Expected Solution:** Output concise test strategy documentation, highlighting core content such as test overview, test objectives, test scope, test strategy, test planning, resource planning, and risk management

**Steps:** Project Analysis → Objective Setting → Strategy Design → Resource Planning → Risk Identification
