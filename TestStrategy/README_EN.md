...
- **[Requirements Analysis](../RequirementsAnalysis/README_EN.md)** - Requirements-based strategy
- **[Test Reporting](../TestReporting/README_EN.md)** - Strategy execution reporting
- **[Automation Testing](../AutomationTesting/README_EN.md)** - Automation strategy
